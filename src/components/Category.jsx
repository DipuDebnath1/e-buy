...
const Category = () => {
    ...
    const electronicsProducts = [
      ...
      const handleNavigateCategory = (value) =>{
    ...
    return (
       ...
       {
           electronicsProducts.map((item, i)=> <div key={i} onClick={()=>handleNavigateCategory(item.category)} className="p-2 text-center border-red-300 border-2 rounded-3xl hover:bg-red-500 hover:text-white transition cursor-pointer">
